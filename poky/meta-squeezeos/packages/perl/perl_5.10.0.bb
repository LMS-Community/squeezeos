...
# Not using:         file://58_debian_cpan_config_path.patch;patch=1 
...
do_install() {
	...
	# Remove some unicore files that aren't needed
	rm -r ${D}/${prefix}/share/perl/5.10.0/unicore/Name.pl
	rm -r ${D}/${prefix}/share/perl/5.10.0/unicore/Decomposition.pl

	# Remove other large modules
	rm -r ${D}/${prefix}/share/perl/5.10.0/CPAN*
	rm -r ${D}/${prefix}/share/perl/5.10.0/Module/CoreList.pm
}
do_stage() {
        ...
        # target configuration, used cross-compiling modules
        install lib/Config.pm ${STAGING_LIBDIR}/perl/${PV}/Config.pm
        ...
        for i in av.h embed.h gv.h keywords.h op.h perlio.h pp.h regexp.h \
                 ...
                 thread.h warnings.h overload.h parser.h regcharclass.h uudmap.h ; do
