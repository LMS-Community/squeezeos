...
do_unpack2() {
	mkdir -p ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010.09/arm-none-linux-gnueabi ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010.09/bin ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010.09/lib ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010.09/libexec ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010.09/share ${CROSS_DIR}
}
