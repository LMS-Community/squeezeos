...
do_unpack2() {
	mkdir -p ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q3/arm-none-linux-gnueabi ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q3/bin ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q3/lib ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q3/libexec ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q3/share ${CROSS_DIR}
}
