...
do_unpack2() {
	mkdir -p ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q1/arm-none-linux-gnueabi ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q1/bin ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q1/lib ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q1/libexec ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2009q1/share ${CROSS_DIR}
}
