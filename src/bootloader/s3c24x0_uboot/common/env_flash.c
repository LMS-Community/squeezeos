...
#if defined (CONFIG_S3C2440A_JTAG_BOOT) || defined(CONFIG_S3C24A0A_JTAG_BOOT) || defined(CONFIG_S3C24X0_JTAG_BOOT) || defined(CONFIG_S3C2410_JTAG_BOOT) || defined (CONFIG_S3C2413_JTAG_BOOT)
	/* Nothing */
#else
