...
typedef struct {
	...
	/* wjluv add NFCONT member for SMDK2440 */
...
#if defined(CONFIG_S3C2440A)||defined(CONFIG_S3C2410)
/*
* changed from '#ifdef CONFIG_S3C2440A' to
*'#if defined(CONFIG_S3C2440A)||defined(CONFIG_S3C2410)'
* by liao on 2005-08-16
*/
