...
#define IODESC_ENT(x) { S3C2440_VA_##x, S3C2440_PA_##x, S3C2440_SZ_##x, MT_DEVICE }
...
extern void s3c24xx_init_uarts(struct s3c2440_uartcfg *cfg, int no);
