/* linux/include/asm/arch-s3c2440/regs-sdi.h
 *
 ...
 *
 * S3C2440 MMC/SDIO register definitions
 *
 *  Changelog:
...
#define S3C2440_SDICON                (0x00)
#define S3C2440_SDIPRE                (0x04)
#define S3C2440_SDICMDARG             (0x08)
#define S3C2440_SDICMDCON             (0x0C)
#define S3C2440_SDICMDSTAT            (0x10)
#define S3C2440_SDIRSP0               (0x14)
#define S3C2440_SDIRSP1               (0x18)
#define S3C2440_SDIRSP2               (0x1C)
#define S3C2440_SDIRSP3               (0x20)
#define S3C2440_SDITIMER              (0x24)
#define S3C2440_SDIBSIZE              (0x28)
#define S3C2440_SDIDCON               (0x2C)
#define S3C2440_SDIDCNT               (0x30)
#define S3C2440_SDIDSTA               (0x34)
#define S3C2440_SDIFSTA               (0x38)
#define S3C2440_SDIDATA               (0x3C)
#define S3C2440_SDIIMSK               (0x40)
...
#define S3C2440_SDICMDCON_INDEX       (0xff)
...
/* constants for S3C2440_SDIDCON_DATMODE */
...
#define S3C2440_SDIDSTA_FIFOFAIL      (1<<8)	/* reserved on 2440 */
...
#define S3C2440_SDIFSTA_TXHALF         (1<<11)
#define S3C2440_SDIFSTA_TXEMPTY        (1<<10)
...
#define S3C2440_SDIIMSK_RESPONSECRC    (1<<17)
#define S3C2440_SDIIMSK_CMDSENT        (1<<16)
#define S3C2440_SDIIMSK_CMDTIMEOUT     (1<<15)
#define S3C2440_SDIIMSK_RESPONSEND     (1<<14)
#define S3C2440_SDIIMSK_READWAIT       (1<<13)
#define S3C2440_SDIIMSK_SDIOIRQ        (1<<12)
#define S3C2440_SDIIMSK_FIFOFAIL       (1<<11)
#define S3C2440_SDIIMSK_CRCSTATUS      (1<<10)
#define S3C2440_SDIIMSK_DATACRC        (1<<9)
#define S3C2440_SDIIMSK_DATATIMEOUT    (1<<8)
#define S3C2440_SDIIMSK_DATAFINISH     (1<<7)
#define S3C2440_SDIIMSK_BUSYFINISH     (1<<6)
#define S3C2440_SDIIMSK_SBITERR        (1<<5)	/* reserved 2440/2440a */
#define S3C2440_SDIIMSK_TXFIFOHALF     (1<<4)
#define S3C2440_SDIIMSK_TXFIFOEMPTY    (1<<3)
#define S3C2440_SDIIMSK_RXFIFOLAST     (1<<2)
#define S3C2440_SDIIMSK_RXFIFOFULL     (1<<1)
#define S3C2440_SDIIMSK_RXFIFOHALF     (1<<0)
