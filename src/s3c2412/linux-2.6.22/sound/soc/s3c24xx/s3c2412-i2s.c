...
#include <asm/arch/regs-s3c2412-iis.h>
...
#if 0
	s3c2410_gpio_setpin(S3C2410_GPE4, 1);
	s3c2410_gpio_cfgpin(S3C2410_GPE4, S3C2410_GPIO_OUTPUT);
#endif

	printk(KERN_INFO "DMA: OUT=%08x, IN=%08x\n",
	       s3c2412_i2s_pcm_stereo_out.dma_addr,
	       s3c2412_i2s_pcm_stereo_in.dma_addr);

	printk(KERN_INFO "GPECON=%08x\n", __raw_readl(S3C2410_GPECON));

	//writel(S3C2410_IISCON_IISEN, s3c2412_i2s.regs + S3C2410_IISCON);
