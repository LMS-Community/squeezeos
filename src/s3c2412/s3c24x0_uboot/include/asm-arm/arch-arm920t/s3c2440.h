...
#define rGPCON_U	(*(volatile unsigned *)0x44800000)
#define rGPCON_M	(*(volatile unsigned *)0x44800004)
#define rGPCON_L	(*(volatile unsigned *)0x44800008)
#define rGPDAT		(*(volatile unsigned *)0x4480000C)      
...
#define NFCMMD			__REG(0x4E000008)
#define NFADDR			__REGb(0x4E00000C)
#define NFDATA			__REGb(0x4E000010)
...
#define rNFCMMD                         (*(volatile unsigned char *)0x4E000008)
...
#define INTSRCPND		__REG(0x40200000)
...
#define INTSUBSRCPND		__REG(0x40200018)
