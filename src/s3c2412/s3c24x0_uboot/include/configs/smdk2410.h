...
#ifdef CONFIG_S3C2410_JTAG_BOOT
#undef CONFIG_S3C2410_JTAG_BOOT   /*defined for using JTag debug*/
#endif
/* Instead of using NOR , we want to use NAND */
#define CONFIG_S3C2410_USE_NAND 1
/* input clock of PLL */
...
#define CONFIG_BOOTCOMMAND	"nandr c 1c0000 30008000; bootm"
