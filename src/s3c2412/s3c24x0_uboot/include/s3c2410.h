...
#define NFDATA8			(*(volatile unsigned char *)0x4E00000C)//S3C2410 JUST SUPPORT BYTE

#define NFCONF                  __REG(0x4E000000)
#define NFCMD                  __REG(0x4E000004)
#define NFADDR                  __REG(0x4E000008)
#define NFECC                 __REG(0x4E000014)
#define NFSTAT                  __REG(0x4E000010)
