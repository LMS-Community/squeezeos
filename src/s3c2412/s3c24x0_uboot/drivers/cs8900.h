...
#if defined (CONFIG_S3C2413_SMDK)
#define CS8900_RTDATA     *(volatile CS8900_REG *)(CS8900_BASE+0x00*CS8900_OFF)
#define CS8900_RTDATA1    *(volatile CS8900_REG *)(CS8900_BASE+0x02*CS8900_OFF)
#define CS8900_TxCMD      *(volatile CS8900_REG *)(CS8900_BASE+0x04*CS8900_OFF)
#define CS8900_TxLEN      *(volatile CS8900_REG *)(CS8900_BASE+0x06*CS8900_OFF)
#define CS8900_ISQ        *(volatile CS8900_REG *)(CS8900_BASE+0x08*CS8900_OFF)
#define CS8900_PPTR       *(volatile CS8900_REG *)(CS8900_BASE+0x0A*CS8900_OFF)
#define CS8900_PDATA      *(volatile CS8900_REG *)(CS8900_BASE+0x0C*CS8900_OFF)
#define CS8900_PDATA1     *(volatile CS8900_REG *)(CS8900_BASE+0x0E*CS8900_OFF)
#else
#define CS8900_RTDATA *(volatile CS8900_REG *)(CS8900_BASE+0x00*CS8900_OFF)
