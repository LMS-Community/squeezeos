...
#define IODESC_ENT(x) { S3C2413_VA_##x, S3C2413_PA_##x, S3C2413_SZ_##x, MT_DEVICE }
...
extern void s3c24xx_init_uarts(struct s3c2413_uartcfg *cfg, int no);
