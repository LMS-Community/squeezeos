/* linux/arch/arm/mach-s3c2440/devs.c
 *
 * Copyright (c) 2004 Simtec Electronics
 * Ben Dooks <ben@simtec.co.uk>
 *
 * Base S3C2440 platform device definitions
 *
...
static struct resource s3c_usb_resource[] = {
	[0] = {
		.start = S3C2440_PA_USBHOST,
		.end   = S3C2440_PA_USBHOST + S3C2440_SZ_USBHOST,
...
static struct resource s3c_lcd_resource[] = {
	[0] = {
		.start = S3C2440_PA_LCD,
		.end   = S3C2440_PA_LCD + S3C2440_SZ_LCD,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_LCD,
...
static struct resource s3c_nand_resource[] = {
	[0] = {
		.start = S3C2440_PA_NAND,
		.end   = S3C2440_PA_NAND + S3C2440_SZ_NAND,
		.flags = IORESOURCE_MEM,
	}
};
...
static struct resource s3c_usbgadget_resource[] = {
	[0] = {
		.start = S3C2440_PA_USBDEV,
		.end   = S3C2440_PA_USBDEV + S3C2440_SZ_USBDEV,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_USBD,
...
static struct resource s3c_wdt_resource[] = {
	[0] = {
		.start = S3C2440_PA_WATCHDOG,
		.end   = S3C2440_PA_WATCHDOG + S3C2440_SZ_WATCHDOG,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_WDT,
...
static struct resource s3c_i2c_resource[] = {
	[0] = {
		.start = S3C2440_PA_IIC,
		.end   = S3C2440_PA_IIC + S3C2440_SZ_IIC,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_IIC,
...
static struct resource s3c_iis_resource[] = {
	[0] = {
		.start = S3C2440_PA_IIS,
		.end   = S3C2440_PA_IIS + S3C2440_SZ_IIS,
		.flags = IORESOURCE_MEM,
	}
};
...
static struct resource s3c_rtc_resource[] = {
	[0] = {
		.start = S3C2440_PA_RTC,
		.end   = S3C2440_PA_RTC + 0xff,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_RTC,
...
static struct resource s3c_adc_resource[] = {
	[0] = {
		.start = S3C2440_PA_ADC,
		.end   = S3C2440_PA_ADC + S3C2440_SZ_ADC,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_TC,
...
static struct resource s3c_sdi_resource[] = {
	[0] = {
		.start = S3C2440_PA_SDI,
		.end   = S3C2440_PA_SDI + S3C2440_SZ_SDI,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SDI,
...
static struct resource s3c_spi0_resource[] = {
	[0] = {
		.start = S3C2440_PA_SPI,
		.end   = S3C2440_PA_SPI + 0x1f,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SPI0,
...
static struct resource s3c_spi1_resource[] = {
	[0] = {
		.start = S3C2440_PA_SPI + 0x20,
		.end   = S3C2440_PA_SPI + 0x20 + 0x1f,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SPI1,
...
static struct resource s3c_timer0_resource[] = {
	[0] = {
		.start = S3C2440_PA_TIMER + 0x0C,
		.end   = S3C2440_PA_TIMER + 0x0C + 0xB,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_TIMER0,
...
static struct resource s3c_timer1_resource[] = {
	[0] = {
		.start = S3C2440_PA_TIMER + 0x18,
		.end   = S3C2440_PA_TIMER + 0x23,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_TIMER1,
...
static struct resource s3c_timer2_resource[] = {
	[0] = {
		.start = S3C2440_PA_TIMER + 0x24,
		.end   = S3C2440_PA_TIMER + 0x2F,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_TIMER2,
...
static struct resource s3c_timer3_resource[] = {
	[0] = {
		.start = S3C2440_PA_TIMER + 0x30,
		.end   = S3C2440_PA_TIMER + 0x3B,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_TIMER3,
