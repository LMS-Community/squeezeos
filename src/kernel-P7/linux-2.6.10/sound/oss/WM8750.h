 ...
 *
 * Philips WM8750 mixer device driver for ALSA
 *
 ...
 * History:
 *
 * 2002-03-13 Tomas Kasparek Initial release - based on wm8750.h from OSS
 * 2002-03-30 Tomas Kasparek Proc filesystem support, complete mixer and DSP
 *                           features support
 */

/* $Id: wm8750.h,v 1.1.1.1 2005/11/16 00:55:04 yongkal Exp $ */

#define WM8750_ALSA_NAME "snd-wm8750"
 ...
 *
 * WM8750 datasheet on page 21: Peak value (dB) = (Peak level - 63.5)*5*log2
 ...
 * WM8750TS datasheet is available at:
 *   http://www-us9.semiconductors.com/acrobat/datasheets/WM8750TS_3.pdf 
 */
...
enum write_through {
	...
	REGS_ONLY=0,
	//update local regs and write value to wm8750 - do l3_write
	FLUSH,
};

int __init snd_chip_wm8750_mixer_new(snd_card_t *card, struct l3_client **clnt);
