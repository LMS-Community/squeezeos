...
int pcm1770_open(struct pcm1770 *uda)
{
...
#endif
	// SPI port initial
	(*(volatile unsigned int __force *)S3C2413_GPBCON &= ~(0xfffffc0f));
	(*(volatile unsigned int __force *)S3C2413_GPBCON |= 0x00000150);
	...
	pcm1770_SEND_CMD(0x03,0x80);		//Oversampling Control(384fs) Polarity Control(not inverted)
...
{
	(*(volatile unsigned int __force *)S3C2413_GPBDAT) = (*(volatile unsigned int __force *)S3C2413_GPBDAT & ~(0x1<<2)) | ((~data & 0x1)<<2);
}

//---------------------------------------------------------------------------------------------------------
void SPI_SDA(int data)
{
	(*(volatile unsigned int __force *)S3C2413_GPBDAT) = (*(volatile unsigned int __force *)S3C2413_GPBDAT & ~(0x1<<3)) | ((~data & 0x1)<<3);
}
