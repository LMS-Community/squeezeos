/* linux/include/asm-arm/arch-s3c2413/regs-nand.h
 *
 ...
 *
 * Rahul  : 31st Oct, 2005
 *		Changed register addresses and corresponding bits for S3C2413
 *
*/

#ifndef __ASM_ARM_REGS_NAND
#define __ASM_ARM_REGS_NAND "$Id: regs-nand.h,v 1.1.1.1 2005/11/16 00:55:04 yongkal Exp $"


#define S3C2413_NFREG(x) (x)

#define S3C2413_NFCONF		S3C2413_NFREG(0x00)
#define S3C2413_NFCONT		S3C2413_NFREG(0x04)
#define S3C2413_NFCMMD		S3C2413_NFREG(0x08)
#define S3C2413_NFADDR		S3C2413_NFREG(0x0c)
#define S3C2413_NFDATA8     S3C2413_NFREG(0x10)
#define S3C2413_NFDATA     	S3C2413_NFREG(0x10)
#define S3C2413_NFDATA32	S3C2413_NFREG(0x10)
#define S3C2413_NFMECCD0	S3C2413_NFREG(0x14)
#define S3C2413_NFMECCD1	S3C2413_NFREG(0x18)
#define S3C2413_NFSECCD		S3C2413_NFREG(0x1c)
#define S3C2413_NFSBLK		S3C2413_NFREG(0x20)
#define S3C2413_NFEBLK		S3C2413_NFREG(0x24)
#define S3C2413_NFSTAT		S3C2413_NFREG(0x28)

// rahul
/*
*  same as NFECCERR0 and NFECCERR1 ECC error status registers
*  of S3C2413, did not change the names to maintain consistency 
*/
#define S3C2413_NFESTAT0	S3C2413_NFREG(0x2c) 
#define S3C2413_NFESTAT1	S3C2413_NFREG(0x30)


#define S3C2413_NFMECC0		S3C2413_NFREG(0x34)
#define S3C2413_NFMECC1		S3C2413_NFREG(0x38)


#define S3C2413_NFSECC		S3C2413_NFREG(0x3c)

/* 4-bit ECC error bit pattern register - newly added in s3c2413*/
#define S3C2413_NFMLCBITPT	S3C2413_NFREG(0x40)


/* Bit assignments */
#define NFCONT_INITECC		((1<<4)|(1<<5))

#define NFCONT_LOCKMECC		(1<<7)
#define NFCONT_LOCKSECC		(1<<6)
#define NFCONT_LOCKTGHT		(1<<17)
#define NFCONT_LOCKSOFT		(1<<16)

/* TO DO Check Again  ??? check */
...
#define S3C2413_NFSTAT_BUSY        (1<<0)
 ...
 * NFCONT
 */
#define fNFCONT_LockTight		Fld(1,17)
#define fNFCONT_SoftLock		Fld(1,16)
...
#define fNFCONT_MainECCLock		Fld(1,7)
#define fNFCONT_InitECC			Fld(2,4) // ??? check


#define fNFCONT_Reg_nCE			Fld(2,1)  // ??? check
 ...
 * NFSTAT
 */
#define fNFSTAT_IllegalAccess	Fld(1,5)
#define fNFSTAT_RnB_TransDetect	Fld(1,4)


#define fNFSTAT_nCE				Fld(1,2) // ???? check
//#define fNFSTAT_nCE				Fld(1,3)
