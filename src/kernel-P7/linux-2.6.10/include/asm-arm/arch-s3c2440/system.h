 ...
 *
 * S3C2440 - System function defines and includes
 *
...
{
	unsigned long reg = S3C2440_CLKCON;
	unsigned long tmp;
	int i;
...
arch_reset(char mode)
{
	...
	__raw_writel(0, S3C2440_WTCON);	  /* disable watchdog, to be safe  */

	/* put initial values into count and data */
	__raw_writel(0x100, S3C2440_WTCNT);
	__raw_writel(0x100, S3C2440_WTDAT);

	/* set the watchdog to go and reset... */
	__raw_writel(S3C2440_WTCON_ENABLE|S3C2440_WTCON_DIV16|S3C2440_WTCON_RSTEN |
		     S3C2440_WTCON_PRESCALE(0x80), S3C2440_WTCON);
