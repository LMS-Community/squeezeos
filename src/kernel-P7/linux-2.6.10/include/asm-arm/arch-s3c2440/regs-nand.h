/* linux/include/asm-arm/arch-s3c2440/regs-nand.h
 *
...
#define S3C2440_NFREG(x) (x)

#define S3C2440_NFCONF		S3C2440_NFREG(0x00)
#define S3C2440_NFCONT		S3C2440_NFREG(0x04)
#define S3C2440_NFCMMD		S3C2440_NFREG(0x08)
#define S3C2440_NFADDR		S3C2440_NFREG(0x0c)
#define S3C2440_NFDATA8     	S3C2440_NFREG(0x10)
#define S3C2440_NFDATA     	S3C2440_NFREG(0x10)
#define S3C2440_NFDATA32	S3C2440_NFREG(0x10)
#define S3C2440_NFMECCD0	S3C2440_NFREG(0x14)
#define S3C2440_NFMECCD1	S3C2440_NFREG(0x18)
#define S3C2440_NFSECCD		S3C2440_NFREG(0x1c)
#define S3C2440_NFSTAT		S3C2440_NFREG(0x20)
#define S3C2440_NFESTAT0	S3C2440_NFREG(0x24)
#define S3C2440_NFESTAT1	S3C2440_NFREG(0x28)
#define S3C2440_NFMECC0		S3C2440_NFREG(0x2c)
#define S3C2440_NFMECC1		S3C2440_NFREG(0x30)
#define S3C2440_NFSECC		S3C2440_NFREG(0x34)
#define S3C2440_NFSBLK		S3C2440_NFREG(0x38)
#define S3C2440_NFEBLK		S3C2440_NFREG(0x3c)

#define NFCONT_INITECC		(1<<4)
#define NFCONT_LOCKMECC		(1<<5)
#define NFCONT_LOCKSECC		(1<<6)
#define NFCONT_LOCKTGHT		(1<<13)
#define NFCONT_LOCKSOFT		(1<<12)
