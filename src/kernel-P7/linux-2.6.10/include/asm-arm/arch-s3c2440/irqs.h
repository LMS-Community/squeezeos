...
#define IRQ_RESERVED6  S3C2440_IRQ(6)
...
#define IRQ_RESERVED24 S3C2440_IRQ(24)	    /* 40 */
...
#define IRQ_EINT(x)    S3C2440_IRQ((x >= 4) ? (IRQ_EINT4 + (x) - 4) : (S3C2440_IRQ(0) + (x)))
...
*/
#define IRQ_S3CUART_RX0  S3C2440_IRQ(54-2)   /* 70 */
#define IRQ_S3CUART_TX0  S3C2440_IRQ(55-2)   /* 71 */
#define IRQ_S3CUART_ERR0 S3C2440_IRQ(56-2)

#define IRQ_S3CUART_RX1  S3C2440_IRQ(57-2)
#define IRQ_S3CUART_TX1  S3C2440_IRQ(58-2)
#define IRQ_S3CUART_ERR1 S3C2440_IRQ(59-2)

#define IRQ_S3CUART_RX2  S3C2440_IRQ(60-2)
#define IRQ_S3CUART_TX2  S3C2440_IRQ(61-2)
#define IRQ_S3CUART_ERR2 S3C2440_IRQ(62-2)

#define IRQ_TC		 S3C2440_IRQ(63-2)
#define IRQ_ADC		 S3C2440_IRQ(64-2)		//jassi -2
