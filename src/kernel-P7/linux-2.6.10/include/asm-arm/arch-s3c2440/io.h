 ...
 *  02-Sep-2003 BJD	Modified for S3C2440
 *
 */
...
#define PCIO_BASE	 (S3C2440_VA_ISA_WORD)
#define PCIO_BASE_b	 (S3C2440_VA_ISA_BYTE)
#define PCIO_BASE_w	 (S3C2440_VA_ISA_WORD)
#define PCIO_BASE_l	 (S3C2440_VA_ISA_WORD)
/*
