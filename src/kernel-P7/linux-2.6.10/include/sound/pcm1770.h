 ...
 *
 * Philips PCM1770 mixer device driver for ALSA
 *
 ...
 * History:
 *
 * 2002-03-13 Tomas Kasparek Initial release - based on pcm1770.h from OSS
 * 2002-03-30 Tomas Kasparek Proc filesystem support, complete mixer and DSP
 *                           features support
 */

/* $Id: pcm1770.h,v 1.1.1.1 2005/11/16 00:55:04 yongkal Exp $ */

#define PCM1770_ALSA_NAME "snd-pcm1770"
 ...
 *
 * PCM1770 datasheet on page 21: Peak value (dB) = (Peak level - 63.5)*5*log2
 ...
 * PCM1770TS datasheet is available at:
 *   http://www-us9.semiconductors.com/acrobat/datasheets/PCM1770TS_3.pdf 
 */
...
enum write_through {
	...
	REGS_ONLY=0,
	//update local regs and write value to pcm1770 - do l3_write
	FLUSH,
};

int __init snd_chip_pcm1770_mixer_new(snd_card_t *card, struct l3_client **clnt);
