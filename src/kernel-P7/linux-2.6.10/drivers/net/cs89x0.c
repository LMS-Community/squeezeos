...
#if	defined(CONFIG_ARCH_SMDK2440) || defined(CONFIG_ARCH_SMDK2413)
#include <asm/irq.h>
...
#elif defined(CONFIG_ARCH_SMDK2440)
static unsigned int netcard_portlist[] __initdata = 
	{S3C2440_VA_CS8900/*0xF1300000*/ + 0x300, 0};
static unsigned int cs8900_irq_map[] = {IRQ_EINT9,0,0,0};
#elif defined(CONFIG_ARCH_SMDK2411)
static unsigned int netcard_portlist[] __initdata = 
	{S3C2413_VA_CS8900/*0xF1300000*/+0x600 , 0};
static unsigned int cs8900_irq_map[] = {IRQ_EINT3,0,0,0};
#elif defined(CONFIG_ARCH_SMDK2413)
static unsigned int netcard_portlist[] __initdata = 
	{S3C2413_VA_CS8900/*0xF1300000*/+0x600 , 0};
static unsigned int cs8900_irq_map[] = {IRQ_EINT22,0,0,0};
#else
static unsigned int netcard_portlist[] __initdata =
...
#if defined  (CONFIG_ARCH_SMDK2413) || #defined(CONFIG_ARCH_SMDK2440)
	if(unit > 0){
		err = -ENODEV;
		return ERR_PTR(err);
	}
...
printk("ioaddr %x\n ",ioaddr);
	...
	set_irq_type(cs8900_irq_map[0], IRQT_RISING);
#endif
...
#endif
	{
#if !defined(CONFIG_ARCH_SMDK2440) && !defined(CONFIG_ARCH_IXDP2X01) && !defined(CONFIG_ARCH_SMDK2413)
...
do{
        int i, len = length >> 1;
	void *to = skb_put(skb, length);
	unsigned int port = ioaddr + RX_FRAME_PORT;
