...
static int jive_mgmt_ioctl(struct inode *inode, struct file *filp, unsigned int cmd, unsigned long arg) {
	...
	case JIVE_MGMT_IOCGCHGACPR:
		s3c2413_gpio_cfgpin(S3C2413_GPG3, S3C2413_GPG3_INP);
		val = (s3c2413_gpio_getpin(S3C2413_GPG3) > 0);
		s3c2413_gpio_cfgpin(S3C2413_GPG3, S3C2413_GPG3_EINT11);
		break;
...
static int __init jive_mgmt_init(void) {
	...
	// GPG8 <= CHG_ACPR
	s3c2413_gpio_cfgpin(S3C2413_GPG3, S3C2413_GPG3_EINT11);
	s3c2413_gpio_pullup(S3C2413_GPG3, 1);

	// EINT[11] both edge triggered
