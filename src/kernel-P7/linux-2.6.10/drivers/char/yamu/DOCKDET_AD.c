...
//===================================================================
unsigned char DOCKDET_AD_MAJOR = 232;

//===================================================================
int DOCKDET_AD_open (struct inode *inode, struct file *filp)
{
	return 0;
}

int DOCKDET_AD_release (struct inode *inode, struct file *filp)
{
	return 0;
}

//===================================================================
ssize_t DOCKDET_AD_read (struct file *filp, char *buf, size_t count, loff_t *f_pos)
{
	...
	for(i=0; i<5; i++) {
		(*(volatile unsigned int __force *)S3C2413_ADCCON) =S3C2413_ADCCON_PRSCEN | S3C2413_ADCCON_PRSCVL(0x70)|S3C2413_ADCCON_SELMUX(0x00);	//AIN0
		udelay(10);
...
//===================================================================
struct file_operations DOCKDET_AD_fops = {
	read:     	DOCKDET_AD_read,
	open:    	DOCKDET_AD_open,
	release:  	DOCKDET_AD_release,
};

//===================================================================
static int __init DOCKDET_AD_init(void)
{
	int result;

  	result = register_chrdev(DOCKDET_AD_MAJOR, "DOCKDET_AD", &DOCKDET_AD_fops);
  	if (result < 0) {
   		printk(KERN_WARNING " can't get major \n");
   		return result;
  	}

  	printk("DOCKDET_AD_MAJOR = %d\n", DOCKDET_AD_MAJOR);
  	return 0;
}

static void __exit DOCKDET_AD_exit(void)
{
	unregister_chrdev(DOCKDET_AD_MAJOR, "DOCKDET_AD");
}

//===================================================================

module_init(DOCKDET_AD_init);
module_exit(DOCKDET_AD_exit);
