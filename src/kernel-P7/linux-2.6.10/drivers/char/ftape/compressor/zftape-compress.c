 ...
 */
 ...
 char zftc_src[] ="$Source: /home/cvs/s3c2413_kernel2.6.10_dev/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2006-09-26 00:11:10 +0100 (Tue, 26 Sep 2006) $";
