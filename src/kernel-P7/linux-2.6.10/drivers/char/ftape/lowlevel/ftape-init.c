...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /home/cvs/s3c2413_kernel2.6.10_dev/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2006-09-26 00:11:10 +0100 (Tue, 26 Sep 2006) $";
